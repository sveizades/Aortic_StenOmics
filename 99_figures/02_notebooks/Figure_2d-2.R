# Figure 2d-2: Boxplot of Contractile VIC proportion by disease severity (UBC snRNA-seq).
library(Seurat)
library(ggplot2)
library(dplyr)
library(tidyr)
...
selected_celltype <- "Contractile"  # Replace with actual VIC subtype
...
ggsave(plot = plt,
       filename = paste0(main_figure_output_path, "Figure_2d-2.svg"),
       width = 1.5,
       height = 2.5,
       units = "cm")
