# Figure 4j-1: Spatial niche and VIC subtype maps for BXNFB_C1
...
ggsave(plot = plt, 
       filename = paste0(main_figure_output_path, "Figure_4j-FAPIdim-niches.svg"), 
       width = 3, 
       height = 3, 
       units = "cm")
...
ggsave(plot = plt, 
       filename = paste0(main_figure_output_path, "Figure_4j-FAPIdim-niches-zoom.svg"), 
       width = 3, 
       height = 3, 
       units = "cm")
write.csv(df_BXNFB_C1, file = paste0(source_data_output_path, "Figure_4j-1.csv"), row.names = TRUE)
